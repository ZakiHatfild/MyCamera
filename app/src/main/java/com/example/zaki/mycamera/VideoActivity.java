...
public class VideoActivity extends AppCompatActivity {
        ...
        Drawer dr = new Drawer()
                ...
                .withOnDrawerListener(new Drawer.OnDrawerListener() {
                    ...
                    public void onDrawerOpened(View drawerView) {
                        InputMethodManager inputMethodManager = (InputMethodManager) VideoActivity.this.getSystemService(Activity.INPUT_METHOD_SERVICE);
                        inputMethodManager.hideSoftInputFromWindow(VideoActivity.this.getCurrentFocus().getWindowToken(), 0);
                    }
                    @Override
    ...
    private boolean prepareVideoRecorder() {
        ...
        String fileName = getTime().replaceAll(" ", "") + ".MP4";
        File file = new File(videos.getAbsolutePath()+File.separator+fileName);
        ...
        try {
            ...
            Toast.makeText(getApplicationContext(), "Out of Memory. Delete Some Files", Toast.LENGTH_SHORT).show();
            releaseMediaRecorder();
            return false;
        }
        return true;
